...
def setup_environment():
    ...
    mlflow.set_experiment("tourism_recommendation_enhanced")
...
def train_content_based():
    ...
    with mlflow.start_run(run_name="content_based_tfidf"):
        ...
        if predictions:
            ...
            logger.info(f"Content-based - RMSE: {rmse:.4f}, MAE: {mae:.4f}, F1: {f1:.4f}")
            return rmse, mae
...
def train_neural_collaborative_filtering():
    ...
    with mlflow.start_run(run_name="neural_collaborative_filtering"):
        ...
        logger.info(f"Neural CF - RMSE: {rmse:.4f}, MAE: {mae:.4f}, NDCG@10: {ndcg_10:.4f}")
        return rmse, mae
...
def train_ensemble_model():
    ...
    with mlflow.start_run(run_name="ensemble_model"):
        ...
        logger.info(f"Ensemble Model - RMSE: {rmse:.4f}, MAE: {mae:.4f}, F1: {f1:.4f}, NDCG@10: {ndcg_10:.4f}")
        return rmse, mae
